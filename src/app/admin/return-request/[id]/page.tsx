import CustomerTransactionsTable from '@/components/Admin/Customers/CustomerDetails/CustomerTransactions';
...
export default function AdminReturnRequestDetails() {
  return (
    <section className='py-8'>
      <p className='text-xl font-medium text-gray-700 mb-8'>Return Request</p>
            ...
            <div className='rounded-xl bg-gray-50 p-8 border border-gray-200'>
              <div className='flex items-center justify-center gap-4 flex-wrap'>
                {[1, 2, 3].map((el) => (
                  <Image
                    key={el}
                    src={orders[0].orderProduct[0].image}
                    alt='image'
                    width={100}
                    height={100}
                    className='h-28 w-28'
